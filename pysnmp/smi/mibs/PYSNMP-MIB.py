...
#
# ASN.1 source http://mibs.pysnmp.com/asn1/PYSNMP-MIB.txt
...
pysnmpObjects = _PysnmpObjects_ObjectIdentity((1, 3, 6, 1, 4, 1, 20408, 1))
_PysnmpExamples_ObjectIdentity = ObjectIdentity
pysnmpExamples = _PysnmpExamples_ObjectIdentity((1, 3, 6, 1, 4, 1, 20408, 2))
_PysnmpEnumerations_ObjectIdentity = ObjectIdentity
pysnmpEnumerations = _PysnmpEnumerations_ObjectIdentity((1, 3, 6, 1, 4, 1, 20408, 3))
_PysnmpModuleIDs_ObjectIdentity = ObjectIdentity
pysnmpModuleIDs = _PysnmpModuleIDs_ObjectIdentity((1, 3, 6, 1, 4, 1, 20408, 3, 1))
_PysnmpAgentOIDs_ObjectIdentity = ObjectIdentity
pysnmpAgentOIDs = _PysnmpAgentOIDs_ObjectIdentity((1, 3, 6, 1, 4, 1, 20408, 3, 2))
_PysnmpDomains_ObjectIdentity = ObjectIdentity
pysnmpDomains = _PysnmpDomains_ObjectIdentity((1, 3, 6, 1, 4, 1, 20408, 3, 3))
...
pysnmpConformance = _PysnmpConformance_ObjectIdentity((1, 3, 6, 1, 4, 1, 20408, 5))
_PysnmpCompliances_ObjectIdentity = ObjectIdentity
pysnmpCompliances = _PysnmpCompliances_ObjectIdentity((1, 3, 6, 1, 4, 1, 20408, 5, 1))
_PysnmpGroups_ObjectIdentity = ObjectIdentity
pysnmpGroups = _PysnmpGroups_ObjectIdentity((1, 3, 6, 1, 4, 1, 20408, 5, 2))
_PysnmpExperimental_ObjectIdentity = ObjectIdentity
pysnmpExperimental = _PysnmpExperimental_ObjectIdentity((1, 3, 6, 1, 4, 1, 20408, 9999))
