...
atEntry = _AtEntry_Object((1, 3, 6, 1, 2, 1, 3, 1, 1))
...
atPhysAddress = _AtPhysAddress_Object(
    (1, 3, 6, 1, 2, 1, 3, 1, 1, 2), _AtPhysAddress_Type()
)
...
atNetAddress = _AtNetAddress_Object(
    (1, 3, 6, 1, 2, 1, 3, 1, 1, 3), _AtNetAddress_Type()
)
...
class _IpForwarding_Type(Integer32):
    ...
    namedValues = NamedValues(*(("forwarding", 1), ("not-forwarding", 2)))
...
ipInAddrErrors = _IpInAddrErrors_Object(
    (1, 3, 6, 1, 2, 1, 4, 5), _IpInAddrErrors_Type()
)
...
ipForwDatagrams = _IpForwDatagrams_Object(
    (1, 3, 6, 1, 2, 1, 4, 6), _IpForwDatagrams_Type()
)
...
ipInUnknownProtos = _IpInUnknownProtos_Object(
    (1, 3, 6, 1, 2, 1, 4, 7), _IpInUnknownProtos_Type()
)
...
ipReasmTimeout = _IpReasmTimeout_Object(
    (1, 3, 6, 1, 2, 1, 4, 13), _IpReasmTimeout_Type()
)
...
ipAddrTable = _IpAddrTable_Object((1, 3, 6, 1, 2, 1, 4, 20))
if mibBuilder.loadTexts:
...
ipAddrEntry = _IpAddrEntry_Object((1, 3, 6, 1, 2, 1, 4, 20, 1))
...
ipAdEntIfIndex = _IpAdEntIfIndex_Object(
    (1, 3, 6, 1, 2, 1, 4, 20, 1, 2), _IpAdEntIfIndex_Type()
)
...
ipAdEntNetMask = _IpAdEntNetMask_Object(
    (1, 3, 6, 1, 2, 1, 4, 20, 1, 3), _IpAdEntNetMask_Type()
)
...
ipAdEntBcastAddr = _IpAdEntBcastAddr_Object(
    (1, 3, 6, 1, 2, 1, 4, 20, 1, 4), _IpAdEntBcastAddr_Type()
)
...
ipAdEntReasmMaxSize = _IpAdEntReasmMaxSize_Object(
    (1, 3, 6, 1, 2, 1, 4, 20, 1, 5), _IpAdEntReasmMaxSize_Type()
)
...
ipRouteTable = _IpRouteTable_Object((1, 3, 6, 1, 2, 1, 4, 21))
if mibBuilder.loadTexts:
...
ipRouteEntry = _IpRouteEntry_Object((1, 3, 6, 1, 2, 1, 4, 21, 1))
...
ipRouteIfIndex = _IpRouteIfIndex_Object(
    (1, 3, 6, 1, 2, 1, 4, 21, 1, 2), _IpRouteIfIndex_Type()
)
...
ipRouteMetric1 = _IpRouteMetric1_Object(
    (1, 3, 6, 1, 2, 1, 4, 21, 1, 3), _IpRouteMetric1_Type()
)
...
ipRouteMetric2 = _IpRouteMetric2_Object(
    (1, 3, 6, 1, 2, 1, 4, 21, 1, 4), _IpRouteMetric2_Type()
)
...
ipRouteMetric3 = _IpRouteMetric3_Object(
    (1, 3, 6, 1, 2, 1, 4, 21, 1, 5), _IpRouteMetric3_Type()
)
...
ipRouteMetric4 = _IpRouteMetric4_Object(
    (1, 3, 6, 1, 2, 1, 4, 21, 1, 6), _IpRouteMetric4_Type()
)
...
ipRouteNextHop = _IpRouteNextHop_Object(
    (1, 3, 6, 1, 2, 1, 4, 21, 1, 7), _IpRouteNextHop_Type()
)
...
class _IpRouteType_Type(Integer32):
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(SingleValueConstraint(*(1, 2, 3, 4)))
    namedValues = NamedValues(
        *(("direct", 3), ("indirect", 4), ("invalid", 2), ("other", 1))
    )
...
ipRouteProto = _IpRouteProto_Object(
    (1, 3, 6, 1, 2, 1, 4, 21, 1, 9), _IpRouteProto_Type()
)
...
ipRouteMetric5 = _IpRouteMetric5_Object(
    (1, 3, 6, 1, 2, 1, 4, 21, 1, 12), _IpRouteMetric5_Type()
)
...
ipNetToMediaTable = _IpNetToMediaTable_Object((1, 3, 6, 1, 2, 1, 4, 22))
if mibBuilder.loadTexts:
...
ipNetToMediaEntry = _IpNetToMediaEntry_Object((1, 3, 6, 1, 2, 1, 4, 22, 1))
...
ipNetToMediaIfIndex = _IpNetToMediaIfIndex_Object(
    (1, 3, 6, 1, 2, 1, 4, 22, 1, 1), _IpNetToMediaIfIndex_Type()
)
...
ipNetToMediaPhysAddress = _IpNetToMediaPhysAddress_Object(
    (1, 3, 6, 1, 2, 1, 4, 22, 1, 2), _IpNetToMediaPhysAddress_Type()
)
...
ipNetToMediaNetAddress = _IpNetToMediaNetAddress_Object(
    (1, 3, 6, 1, 2, 1, 4, 22, 1, 3), _IpNetToMediaNetAddress_Type()
)
...
class _IpNetToMediaType_Type(Integer32):
    ...
    subtypeSpec += ConstraintsUnion(SingleValueConstraint(*(1, 2, 3, 4)))
    namedValues = NamedValues(
        *(("dynamic", 3), ("invalid", 2), ("other", 1), ("static", 4))
    )
...
ipNetToMediaType = _IpNetToMediaType_Object(
    (1, 3, 6, 1, 2, 1, 4, 22, 1, 4), _IpNetToMediaType_Type()
)
...
ipRoutingDiscards = _IpRoutingDiscards_Object(
    (1, 3, 6, 1, 2, 1, 4, 23), _IpRoutingDiscards_Type()
)
...
icmpInDestUnreachs = _IcmpInDestUnreachs_Object(
    (1, 3, 6, 1, 2, 1, 5, 3), _IcmpInDestUnreachs_Type()
)
...
icmpInTimeExcds = _IcmpInTimeExcds_Object(
    (1, 3, 6, 1, 2, 1, 5, 4), _IcmpInTimeExcds_Type()
)
...
icmpInParmProbs = _IcmpInParmProbs_Object(
    (1, 3, 6, 1, 2, 1, 5, 5), _IcmpInParmProbs_Type()
)
...
icmpInSrcQuenchs = _IcmpInSrcQuenchs_Object(
    (1, 3, 6, 1, 2, 1, 5, 6), _IcmpInSrcQuenchs_Type()
)
...
icmpInRedirects = _IcmpInRedirects_Object(
    (1, 3, 6, 1, 2, 1, 5, 7), _IcmpInRedirects_Type()
)
...
icmpInEchoReps = _IcmpInEchoReps_Object(
    (1, 3, 6, 1, 2, 1, 5, 9), _IcmpInEchoReps_Type()
)
...
icmpInTimestamps = _IcmpInTimestamps_Object(
    (1, 3, 6, 1, 2, 1, 5, 10), _IcmpInTimestamps_Type()
)
...
icmpInTimestampReps = _IcmpInTimestampReps_Object(
    (1, 3, 6, 1, 2, 1, 5, 11), _IcmpInTimestampReps_Type()
)
...
icmpInAddrMasks = _IcmpInAddrMasks_Object(
    (1, 3, 6, 1, 2, 1, 5, 12), _IcmpInAddrMasks_Type()
)
...
icmpInAddrMaskReps = _IcmpInAddrMaskReps_Object(
    (1, 3, 6, 1, 2, 1, 5, 13), _IcmpInAddrMaskReps_Type()
)
...
icmpOutDestUnreachs = _IcmpOutDestUnreachs_Object(
    (1, 3, 6, 1, 2, 1, 5, 16), _IcmpOutDestUnreachs_Type()
)
...
icmpOutTimeExcds = _IcmpOutTimeExcds_Object(
    (1, 3, 6, 1, 2, 1, 5, 17), _IcmpOutTimeExcds_Type()
)
...
icmpOutParmProbs = _IcmpOutParmProbs_Object(
    (1, 3, 6, 1, 2, 1, 5, 18), _IcmpOutParmProbs_Type()
)
...
icmpOutSrcQuenchs = _IcmpOutSrcQuenchs_Object(
    (1, 3, 6, 1, 2, 1, 5, 19), _IcmpOutSrcQuenchs_Type()
)
...
icmpOutRedirects = _IcmpOutRedirects_Object(
    (1, 3, 6, 1, 2, 1, 5, 20), _IcmpOutRedirects_Type()
)
...
icmpOutEchoReps = _IcmpOutEchoReps_Object(
    (1, 3, 6, 1, 2, 1, 5, 22), _IcmpOutEchoReps_Type()
)
...
icmpOutTimestamps = _IcmpOutTimestamps_Object(
    (1, 3, 6, 1, 2, 1, 5, 23), _IcmpOutTimestamps_Type()
)
...
icmpOutTimestampReps = _IcmpOutTimestampReps_Object(
    (1, 3, 6, 1, 2, 1, 5, 24), _IcmpOutTimestampReps_Type()
)
...
icmpOutAddrMasks = _IcmpOutAddrMasks_Object(
    (1, 3, 6, 1, 2, 1, 5, 25), _IcmpOutAddrMasks_Type()
)
...
icmpOutAddrMaskReps = _IcmpOutAddrMaskReps_Object(
    (1, 3, 6, 1, 2, 1, 5, 26), _IcmpOutAddrMaskReps_Type()
)
...
class _TcpRtoAlgorithm_Type(Integer32):
    ...
    subtypeSpec += ConstraintsUnion(SingleValueConstraint(*(1, 2, 3, 4)))
    namedValues = NamedValues(
        *(("constant", 2), ("other", 1), ("rsre", 3), ("vanj", 4))
    )
...
tcpRtoAlgorithm = _TcpRtoAlgorithm_Object(
    (1, 3, 6, 1, 2, 1, 6, 1), _TcpRtoAlgorithm_Type()
)
...
tcpActiveOpens = _TcpActiveOpens_Object(
    (1, 3, 6, 1, 2, 1, 6, 5), _TcpActiveOpens_Type()
)
...
tcpPassiveOpens = _TcpPassiveOpens_Object(
    (1, 3, 6, 1, 2, 1, 6, 6), _TcpPassiveOpens_Type()
)
...
tcpAttemptFails = _TcpAttemptFails_Object(
    (1, 3, 6, 1, 2, 1, 6, 7), _TcpAttemptFails_Type()
)
...
tcpEstabResets = _TcpEstabResets_Object(
    (1, 3, 6, 1, 2, 1, 6, 8), _TcpEstabResets_Type()
)
...
tcpRetransSegs = _TcpRetransSegs_Object(
    (1, 3, 6, 1, 2, 1, 6, 12), _TcpRetransSegs_Type()
)
...
tcpConnTable = _TcpConnTable_Object((1, 3, 6, 1, 2, 1, 6, 13))
if mibBuilder.loadTexts:
...
tcpConnEntry = _TcpConnEntry_Object((1, 3, 6, 1, 2, 1, 6, 13, 1))
...
tcpConnState = _TcpConnState_Object(
    (1, 3, 6, 1, 2, 1, 6, 13, 1, 1), _TcpConnState_Type()
)
...
tcpConnLocalAddress = _TcpConnLocalAddress_Object(
    (1, 3, 6, 1, 2, 1, 6, 13, 1, 2), _TcpConnLocalAddress_Type()
)
...
tcpConnLocalPort = _TcpConnLocalPort_Object(
    (1, 3, 6, 1, 2, 1, 6, 13, 1, 3), _TcpConnLocalPort_Type()
)
...
tcpConnRemAddress = _TcpConnRemAddress_Object(
    (1, 3, 6, 1, 2, 1, 6, 13, 1, 4), _TcpConnRemAddress_Type()
)
...
tcpConnRemPort = _TcpConnRemPort_Object(
    (1, 3, 6, 1, 2, 1, 6, 13, 1, 5), _TcpConnRemPort_Type()
)
...
udpInDatagrams = _UdpInDatagrams_Object(
    (1, 3, 6, 1, 2, 1, 7, 1), _UdpInDatagrams_Type()
)
...
udpOutDatagrams = _UdpOutDatagrams_Object(
    (1, 3, 6, 1, 2, 1, 7, 4), _UdpOutDatagrams_Type()
)
...
udpTable = _UdpTable_Object((1, 3, 6, 1, 2, 1, 7, 5))
if mibBuilder.loadTexts:
...
udpEntry = _UdpEntry_Object((1, 3, 6, 1, 2, 1, 7, 5, 1))
...
udpLocalAddress = _UdpLocalAddress_Object(
    (1, 3, 6, 1, 2, 1, 7, 5, 1, 1), _UdpLocalAddress_Type()
)
...
udpLocalPort = _UdpLocalPort_Object(
    (1, 3, 6, 1, 2, 1, 7, 5, 1, 2), _UdpLocalPort_Type()
)
...
egp = _Egp_ObjectIdentity((1, 3, 6, 1, 2, 1, 8))
_EgpInMsgs_Type = Counter32
_EgpInMsgs_Object = MibScalar
egpInMsgs = _EgpInMsgs_Object((1, 3, 6, 1, 2, 1, 8, 1), _EgpInMsgs_Type())
...
egpInErrors = _EgpInErrors_Object((1, 3, 6, 1, 2, 1, 8, 2), _EgpInErrors_Type())
...
egpOutMsgs = _EgpOutMsgs_Object((1, 3, 6, 1, 2, 1, 8, 3), _EgpOutMsgs_Type())
...
egpOutErrors = _EgpOutErrors_Object((1, 3, 6, 1, 2, 1, 8, 4), _EgpOutErrors_Type())
...
egpNeighTable = _EgpNeighTable_Object((1, 3, 6, 1, 2, 1, 8, 5))
if mibBuilder.loadTexts:
...
egpNeighEntry = _EgpNeighEntry_Object((1, 3, 6, 1, 2, 1, 8, 5, 1))
...
class _EgpNeighState_Type(Integer32):
    subtypeSpec = Integer32.subtypeSpec
    subtypeSpec += ConstraintsUnion(SingleValueConstraint(*(1, 2, 3, 4, 5)))
    namedValues = NamedValues(
        *(("acquisition", 2), ("cease", 5), ("down", 3), ("idle", 1), ("up", 4))
    )
...
egpNeighState = _EgpNeighState_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 1), _EgpNeighState_Type()
)
...
egpNeighAddr = _EgpNeighAddr_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 2), _EgpNeighAddr_Type()
)
...
egpNeighAs = _EgpNeighAs_Object((1, 3, 6, 1, 2, 1, 8, 5, 1, 3), _EgpNeighAs_Type())
...
egpNeighInMsgs = _EgpNeighInMsgs_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 4), _EgpNeighInMsgs_Type()
)
...
egpNeighInErrs = _EgpNeighInErrs_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 5), _EgpNeighInErrs_Type()
)
...
egpNeighOutMsgs = _EgpNeighOutMsgs_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 6), _EgpNeighOutMsgs_Type()
)
...
egpNeighOutErrs = _EgpNeighOutErrs_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 7), _EgpNeighOutErrs_Type()
)
...
egpNeighInErrMsgs = _EgpNeighInErrMsgs_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 8), _EgpNeighInErrMsgs_Type()
)
...
egpNeighOutErrMsgs = _EgpNeighOutErrMsgs_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 9), _EgpNeighOutErrMsgs_Type()
)
...
egpNeighStateUps = _EgpNeighStateUps_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 10), _EgpNeighStateUps_Type()
)
...
egpNeighStateDowns = _EgpNeighStateDowns_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 11), _EgpNeighStateDowns_Type()
)
...
egpNeighIntervalHello = _EgpNeighIntervalHello_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 12), _EgpNeighIntervalHello_Type()
)
...
egpNeighIntervalPoll = _EgpNeighIntervalPoll_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 13), _EgpNeighIntervalPoll_Type()
)
...
egpNeighMode = _EgpNeighMode_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 14), _EgpNeighMode_Type()
)
...
egpNeighEventTrigger = _EgpNeighEventTrigger_Object(
    (1, 3, 6, 1, 2, 1, 8, 5, 1, 15), _EgpNeighEventTrigger_Type()
)
...
egpAs = _EgpAs_Object((1, 3, 6, 1, 2, 1, 8, 6), _EgpAs_Type())
