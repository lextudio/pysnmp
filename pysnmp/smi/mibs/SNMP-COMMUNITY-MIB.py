...
#
# ASN.1 source http://mibs.pysnmp.com/asn1/SNMP-COMMUNITY-MIB.txt
...
snmpCommunityTable = _SnmpCommunityTable_Object((1, 3, 6, 1, 6, 3, 18, 1, 1))
if mibBuilder.loadTexts:
...
snmpCommunityEntry = _SnmpCommunityEntry_Object((1, 3, 6, 1, 6, 3, 18, 1, 1, 1))
...
snmpCommunityIndex = _SnmpCommunityIndex_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 1, 1, 1), _SnmpCommunityIndex_Type()
)
...
snmpCommunityName = _SnmpCommunityName_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 1, 1, 2), _SnmpCommunityName_Type()
)
...
snmpCommunitySecurityName = _SnmpCommunitySecurityName_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 1, 1, 3), _SnmpCommunitySecurityName_Type()
)
...
snmpCommunityContextEngineID = _SnmpCommunityContextEngineID_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 1, 1, 4), _SnmpCommunityContextEngineID_Type()
)
...
snmpCommunityContextName = _SnmpCommunityContextName_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 1, 1, 5), _SnmpCommunityContextName_Type()
)
...
snmpCommunityTransportTag = _SnmpCommunityTransportTag_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 1, 1, 6), _SnmpCommunityTransportTag_Type()
)
...
snmpCommunityStorageType = _SnmpCommunityStorageType_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 1, 1, 7), _SnmpCommunityStorageType_Type()
)
...
snmpCommunityStatus = _SnmpCommunityStatus_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 1, 1, 8), _SnmpCommunityStatus_Type()
)
...
snmpTargetAddrExtTable = _SnmpTargetAddrExtTable_Object((1, 3, 6, 1, 6, 3, 18, 1, 2))
if mibBuilder.loadTexts:
...
snmpTargetAddrExtEntry = _SnmpTargetAddrExtEntry_Object((1, 3, 6, 1, 6, 3, 18, 1, 2, 1))
...
snmpTargetAddrTMask = _SnmpTargetAddrTMask_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 2, 1, 1), _SnmpTargetAddrTMask_Type()
)
...
snmpTargetAddrMMS = _SnmpTargetAddrMMS_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 2, 1, 2), _SnmpTargetAddrMMS_Type()
)
...
snmpTrapAddress = _SnmpTrapAddress_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 3), _SnmpTrapAddress_Type()
)
...
snmpTrapCommunity = _SnmpTrapCommunity_Object(
    (1, 3, 6, 1, 6, 3, 18, 1, 4), _SnmpTrapCommunity_Type()
)
...
snmpCommunityGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 18, 2, 2, 1))
...
snmpProxyTrapForwardGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 18, 2, 2, 3))
...
snmpCommunityMIBCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 18, 2, 1, 1))
if mibBuilder.loadTexts:
    snmpCommunityMIBCompliance.setStatus("current")
if mibBuilder.loadTexts:
...
snmpProxyTrapForwardCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 18, 2, 1, 2))
if mibBuilder.loadTexts:
    snmpProxyTrapForwardCompliance.setStatus("current")
if mibBuilder.loadTexts:
