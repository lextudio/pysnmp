...
snmpMPDAdmin = _SnmpMPDAdmin_ObjectIdentity((1, 3, 6, 1, 6, 3, 11, 1))
...
snmpUnknownSecurityModels = _SnmpUnknownSecurityModels_Object(
    (1, 3, 6, 1, 6, 3, 11, 2, 1, 1), _SnmpUnknownSecurityModels_Type()
)
...
snmpInvalidMsgs = _SnmpInvalidMsgs_Object(
    (1, 3, 6, 1, 6, 3, 11, 2, 1, 2), _SnmpInvalidMsgs_Type()
)
...
snmpUnknownPDUHandlers = _SnmpUnknownPDUHandlers_Object(
    (1, 3, 6, 1, 6, 3, 11, 2, 1, 3), _SnmpUnknownPDUHandlers_Type()
)
...
snmpMPDMIBConformance = _SnmpMPDMIBConformance_ObjectIdentity((1, 3, 6, 1, 6, 3, 11, 3))
...
snmpMPDMIBGroups = _SnmpMPDMIBGroups_ObjectIdentity((1, 3, 6, 1, 6, 3, 11, 3, 2))

snmpMPDGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 11, 3, 2, 1))
...
snmpMPDCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 11, 3, 1, 1))
if mibBuilder.loadTexts:
    snmpMPDCompliance.setStatus("current")
if mibBuilder.loadTexts:
