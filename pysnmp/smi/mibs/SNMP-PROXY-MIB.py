...
(TextualConvention, DisplayString, StorageType, RowStatus) = mibBuilder.importSymbols(
    "SNMPv2-TC", "TextualConvention", "DisplayString", "StorageType", "RowStatus"
)
...
snmpProxyObjects = _SnmpProxyObjects_ObjectIdentity((1, 3, 6, 1, 6, 3, 14, 1))
_SnmpProxyTable_Object = MibTable
snmpProxyTable = _SnmpProxyTable_Object((1, 3, 6, 1, 6, 3, 14, 1, 2))
if mibBuilder.loadTexts:
...
snmpProxyEntry = _SnmpProxyEntry_Object((1, 3, 6, 1, 6, 3, 14, 1, 2, 1))
...
snmpProxyName = _SnmpProxyName_Object(
    (1, 3, 6, 1, 6, 3, 14, 1, 2, 1, 1), _SnmpProxyName_Type()
)
...
snmpProxyContextEngineID = _SnmpProxyContextEngineID_Object(
    (1, 3, 6, 1, 6, 3, 14, 1, 2, 1, 3), _SnmpProxyContextEngineID_Type()
)
...
snmpProxyContextName = _SnmpProxyContextName_Object(
    (1, 3, 6, 1, 6, 3, 14, 1, 2, 1, 4), _SnmpProxyContextName_Type()
)
...
snmpProxyTargetParamsIn = _SnmpProxyTargetParamsIn_Object(
    (1, 3, 6, 1, 6, 3, 14, 1, 2, 1, 5), _SnmpProxyTargetParamsIn_Type()
)
...
snmpProxySingleTargetOut = _SnmpProxySingleTargetOut_Object(
    (1, 3, 6, 1, 6, 3, 14, 1, 2, 1, 6), _SnmpProxySingleTargetOut_Type()
)
...
snmpProxyMultipleTargetOut = _SnmpProxyMultipleTargetOut_Object(
    (1, 3, 6, 1, 6, 3, 14, 1, 2, 1, 7), _SnmpProxyMultipleTargetOut_Type()
)
...
snmpProxyStorageType = _SnmpProxyStorageType_Object(
    (1, 3, 6, 1, 6, 3, 14, 1, 2, 1, 8), _SnmpProxyStorageType_Type()
)
...
snmpProxyRowStatus = _SnmpProxyRowStatus_Object(
    (1, 3, 6, 1, 6, 3, 14, 1, 2, 1, 9), _SnmpProxyRowStatus_Type()
)
...
snmpProxyConformance = _SnmpProxyConformance_ObjectIdentity((1, 3, 6, 1, 6, 3, 14, 3))
...
snmpProxyGroups = _SnmpProxyGroups_ObjectIdentity((1, 3, 6, 1, 6, 3, 14, 3, 2))

snmpProxyGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 14, 3, 2, 3))
...
snmpProxyCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 14, 3, 1, 1))
if mibBuilder.loadTexts:
    snmpProxyCompliance.setStatus("current")
if mibBuilder.loadTexts:
