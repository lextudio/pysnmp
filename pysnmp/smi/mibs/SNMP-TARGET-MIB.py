            ...
            if v in self.DELIMITERS:
                if inDelim:
                    raise error.SmiError(
                        "Leading or multiple delimiters not "
...
snmpTargetAddrTable = _SnmpTargetAddrTable_Object((1, 3, 6, 1, 6, 3, 12, 1, 2))
if mibBuilder.loadTexts:
...
snmpTargetAddrEntry = _SnmpTargetAddrEntry_Object((1, 3, 6, 1, 6, 3, 12, 1, 2, 1))
...
snmpTargetAddrName = _SnmpTargetAddrName_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 2, 1, 1), _SnmpTargetAddrName_Type()
)
...
snmpTargetAddrTDomain = _SnmpTargetAddrTDomain_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 2, 1, 2), _SnmpTargetAddrTDomain_Type()
)
...
snmpTargetAddrTAddress = _SnmpTargetAddrTAddress_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 2, 1, 3), _SnmpTargetAddrTAddress_Type()
)
...
snmpTargetAddrTimeout = _SnmpTargetAddrTimeout_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 2, 1, 4), _SnmpTargetAddrTimeout_Type()
)
...
snmpTargetAddrRetryCount = _SnmpTargetAddrRetryCount_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 2, 1, 5), _SnmpTargetAddrRetryCount_Type()
)
...
snmpTargetAddrTagList = _SnmpTargetAddrTagList_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 2, 1, 6), _SnmpTargetAddrTagList_Type()
)
...
snmpTargetAddrParams = _SnmpTargetAddrParams_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 2, 1, 7), _SnmpTargetAddrParams_Type()
)
...
snmpTargetAddrRowStatus = _SnmpTargetAddrRowStatus_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 2, 1, 9), _SnmpTargetAddrRowStatus_Type()
)
...
snmpTargetParamsTable = _SnmpTargetParamsTable_Object((1, 3, 6, 1, 6, 3, 12, 1, 3))
if mibBuilder.loadTexts:
...
snmpTargetParamsEntry = _SnmpTargetParamsEntry_Object((1, 3, 6, 1, 6, 3, 12, 1, 3, 1))
...
snmpTargetParamsName = _SnmpTargetParamsName_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 3, 1, 1), _SnmpTargetParamsName_Type()
)
...
snmpTargetParamsMPModel = _SnmpTargetParamsMPModel_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 3, 1, 2), _SnmpTargetParamsMPModel_Type()
)
...
snmpTargetParamsSecurityModel = _SnmpTargetParamsSecurityModel_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 3, 1, 3), _SnmpTargetParamsSecurityModel_Type()
)
...
snmpTargetParamsSecurityName = _SnmpTargetParamsSecurityName_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 3, 1, 4), _SnmpTargetParamsSecurityName_Type()
)
...
snmpTargetParamsSecurityLevel = _SnmpTargetParamsSecurityLevel_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 3, 1, 5), _SnmpTargetParamsSecurityLevel_Type()
)
...
snmpTargetParamsRowStatus = _SnmpTargetParamsRowStatus_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 3, 1, 7), _SnmpTargetParamsRowStatus_Type()
)
...
snmpUnavailableContexts = _SnmpUnavailableContexts_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 4), _SnmpUnavailableContexts_Type()
)
...
snmpUnknownContexts = _SnmpUnknownContexts_Object(
    (1, 3, 6, 1, 6, 3, 12, 1, 5), _SnmpUnknownContexts_Type()
)
...
snmpTargetConformance = _SnmpTargetConformance_ObjectIdentity((1, 3, 6, 1, 6, 3, 12, 3))
...
snmpTargetGroups = _SnmpTargetGroups_ObjectIdentity((1, 3, 6, 1, 6, 3, 12, 3, 2))

snmpTargetBasicGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 12, 3, 2, 1))
...
snmpTargetResponseGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 12, 3, 2, 2))
...
snmpTargetCommandResponderGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 12, 3, 2, 3))
...
snmpTargetCommandResponderCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 12, 3, 1, 1))
if mibBuilder.loadTexts:
    snmpTargetCommandResponderCompliance.setStatus("current")
if mibBuilder.loadTexts:
