...
(TextualConvention, DisplayString, AutonomousType) = mibBuilder.importSymbols(
    "SNMPv2-TC", "TextualConvention", "DisplayString", "AutonomousType"
)
...
mibBuilder.exportSymbols(
    ...
    **{"usm3DESEDEPrivProtocol": usm3DESEDEPrivProtocol, "snmpUsmMIB": snmpUsmMIB}
)
