...
(SnmpSecurityLevel, SnmpSecurityModel, SnmpAdminString) = mibBuilder.importSymbols(
    "SNMP-FRAMEWORK-MIB", "SnmpSecurityLevel", "SnmpSecurityModel", "SnmpAdminString"
)
...
vacmContextTable = _VacmContextTable_Object((1, 3, 6, 1, 6, 3, 16, 1, 1))
if mibBuilder.loadTexts:
...
vacmContextEntry = _VacmContextEntry_Object((1, 3, 6, 1, 6, 3, 16, 1, 1, 1))
...
vacmContextName = _VacmContextName_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 1, 1, 1), _VacmContextName_Type()
)
...
vacmSecurityModel = _VacmSecurityModel_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 2, 1, 1), _VacmSecurityModel_Type()
)
...
vacmSecurityName = _VacmSecurityName_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 2, 1, 2), _VacmSecurityName_Type()
)
...
vacmGroupName = _VacmGroupName_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 2, 1, 3), _VacmGroupName_Type()
)
...
vacmSecurityToGroupStatus = _VacmSecurityToGroupStatus_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 2, 1, 5), _VacmSecurityToGroupStatus_Type()
)
...
vacmAccessTable = _VacmAccessTable_Object((1, 3, 6, 1, 6, 3, 16, 1, 4))
if mibBuilder.loadTexts:
...
vacmAccessEntry = _VacmAccessEntry_Object((1, 3, 6, 1, 6, 3, 16, 1, 4, 1))
...
vacmAccessContextPrefix = _VacmAccessContextPrefix_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 4, 1, 1), _VacmAccessContextPrefix_Type()
)
...
vacmAccessSecurityModel = _VacmAccessSecurityModel_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 4, 1, 2), _VacmAccessSecurityModel_Type()
)
...
vacmAccessSecurityLevel = _VacmAccessSecurityLevel_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 4, 1, 3), _VacmAccessSecurityLevel_Type()
)
...
class _VacmAccessContextMatch_Type(Integer32):
    ...
    namedValues = NamedValues(*(("exact", 1), ("prefix", 2)))
...
vacmAccessContextMatch = _VacmAccessContextMatch_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 4, 1, 4), _VacmAccessContextMatch_Type().clone("exact")
)
...
vacmAccessReadViewName = _VacmAccessReadViewName_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 4, 1, 5), _VacmAccessReadViewName_Type()
)
...
vacmAccessWriteViewName = _VacmAccessWriteViewName_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 4, 1, 6), _VacmAccessWriteViewName_Type()
)
...
vacmAccessNotifyViewName = _VacmAccessNotifyViewName_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 4, 1, 7), _VacmAccessNotifyViewName_Type()
)
...
vacmAccessStatus = _VacmAccessStatus_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 4, 1, 9), _VacmAccessStatus_Type()
)
...
vacmViewSpinLock = _VacmViewSpinLock_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 5, 1), _VacmViewSpinLock_Type()
)
...
vacmViewTreeFamilyViewName = _VacmViewTreeFamilyViewName_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 5, 2, 1, 1), _VacmViewTreeFamilyViewName_Type()
)
...
vacmViewTreeFamilySubtree = _VacmViewTreeFamilySubtree_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 5, 2, 1, 2), _VacmViewTreeFamilySubtree_Type()
)
...
vacmViewTreeFamilyMask = _VacmViewTreeFamilyMask_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 5, 2, 1, 3), _VacmViewTreeFamilyMask_Type()
)
...
vacmViewTreeFamilyStatus = _VacmViewTreeFamilyStatus_Object(
    (1, 3, 6, 1, 6, 3, 16, 1, 5, 2, 1, 6), _VacmViewTreeFamilyStatus_Type()
)
...
vacmMIBConformance = _VacmMIBConformance_ObjectIdentity((1, 3, 6, 1, 6, 3, 16, 2))
_VacmMIBCompliances_ObjectIdentity = ObjectIdentity
vacmMIBCompliances = _VacmMIBCompliances_ObjectIdentity((1, 3, 6, 1, 6, 3, 16, 2, 1))
_VacmMIBGroups_ObjectIdentity = ObjectIdentity
vacmMIBGroups = _VacmMIBGroups_ObjectIdentity((1, 3, 6, 1, 6, 3, 16, 2, 2))

vacmBasicGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 16, 2, 2, 1))
...
vacmMIBCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 16, 2, 1, 1))
if mibBuilder.loadTexts:
    vacmMIBCompliance.setStatus("current")
if mibBuilder.loadTexts:
