...
(TimeStamp, DisplayString, TestAndIncr, TextualConvention) = mibBuilder.importSymbols(
    "SNMPv2-TC", "TimeStamp", "DisplayString", "TestAndIncr", "TextualConvention"
)
...
sysORLastChange = _SysORLastChange_Object(
    (1, 3, 6, 1, 2, 1, 1, 8), _SysORLastChange_Type()
)
...
sysORTable = _SysORTable_Object((1, 3, 6, 1, 2, 1, 1, 9))
if mibBuilder.loadTexts:
...
sysOREntry = _SysOREntry_Object((1, 3, 6, 1, 2, 1, 1, 9, 1))
...
sysORIndex = _SysORIndex_Object((1, 3, 6, 1, 2, 1, 1, 9, 1, 1), _SysORIndex_Type())
...
sysORID = _SysORID_Object((1, 3, 6, 1, 2, 1, 1, 9, 1, 2), _SysORID_Type())
...
sysORDescr = _SysORDescr_Object((1, 3, 6, 1, 2, 1, 1, 9, 1, 3), _SysORDescr_Type())
...
sysORUpTime = _SysORUpTime_Object((1, 3, 6, 1, 2, 1, 1, 9, 1, 4), _SysORUpTime_Type())
...
snmpInBadVersions = _SnmpInBadVersions_Object(
    (1, 3, 6, 1, 2, 1, 11, 3), _SnmpInBadVersions_Type()
)
...
snmpInBadCommunityNames = _SnmpInBadCommunityNames_Object(
    (1, 3, 6, 1, 2, 1, 11, 4), _SnmpInBadCommunityNames_Type()
)
...
snmpInBadCommunityUses = _SnmpInBadCommunityUses_Object(
    (1, 3, 6, 1, 2, 1, 11, 5), _SnmpInBadCommunityUses_Type()
)
...
snmpInASNParseErrs = _SnmpInASNParseErrs_Object(
    (1, 3, 6, 1, 2, 1, 11, 6), _SnmpInASNParseErrs_Type()
)
...
snmpInNoSuchNames = _SnmpInNoSuchNames_Object(
    (1, 3, 6, 1, 2, 1, 11, 9), _SnmpInNoSuchNames_Type()
)
...
snmpInBadValues = _SnmpInBadValues_Object(
    (1, 3, 6, 1, 2, 1, 11, 10), _SnmpInBadValues_Type()
)
...
snmpInReadOnlys = _SnmpInReadOnlys_Object(
    (1, 3, 6, 1, 2, 1, 11, 11), _SnmpInReadOnlys_Type()
)
...
snmpInTotalReqVars = _SnmpInTotalReqVars_Object(
    (1, 3, 6, 1, 2, 1, 11, 13), _SnmpInTotalReqVars_Type()
)
...
snmpInTotalSetVars = _SnmpInTotalSetVars_Object(
    (1, 3, 6, 1, 2, 1, 11, 14), _SnmpInTotalSetVars_Type()
)
...
snmpInGetRequests = _SnmpInGetRequests_Object(
    (1, 3, 6, 1, 2, 1, 11, 15), _SnmpInGetRequests_Type()
)
...
snmpInGetNexts = _SnmpInGetNexts_Object(
    (1, 3, 6, 1, 2, 1, 11, 16), _SnmpInGetNexts_Type()
)
...
snmpInSetRequests = _SnmpInSetRequests_Object(
    (1, 3, 6, 1, 2, 1, 11, 17), _SnmpInSetRequests_Type()
)
...
snmpInGetResponses = _SnmpInGetResponses_Object(
    (1, 3, 6, 1, 2, 1, 11, 18), _SnmpInGetResponses_Type()
)
...
snmpOutTooBigs = _SnmpOutTooBigs_Object(
    (1, 3, 6, 1, 2, 1, 11, 20), _SnmpOutTooBigs_Type()
)
...
snmpOutNoSuchNames = _SnmpOutNoSuchNames_Object(
    (1, 3, 6, 1, 2, 1, 11, 21), _SnmpOutNoSuchNames_Type()
)
...
snmpOutBadValues = _SnmpOutBadValues_Object(
    (1, 3, 6, 1, 2, 1, 11, 22), _SnmpOutBadValues_Type()
)
...
snmpOutGenErrs = _SnmpOutGenErrs_Object(
    (1, 3, 6, 1, 2, 1, 11, 24), _SnmpOutGenErrs_Type()
)
...
snmpOutGetRequests = _SnmpOutGetRequests_Object(
    (1, 3, 6, 1, 2, 1, 11, 25), _SnmpOutGetRequests_Type()
)
...
snmpOutGetNexts = _SnmpOutGetNexts_Object(
    (1, 3, 6, 1, 2, 1, 11, 26), _SnmpOutGetNexts_Type()
)
...
snmpOutSetRequests = _SnmpOutSetRequests_Object(
    (1, 3, 6, 1, 2, 1, 11, 27), _SnmpOutSetRequests_Type()
)
...
snmpOutGetResponses = _SnmpOutGetResponses_Object(
    (1, 3, 6, 1, 2, 1, 11, 28), _SnmpOutGetResponses_Type()
)
...
class _SnmpEnableAuthenTraps_Type(Integer32):
    ...
    namedValues = NamedValues(*(("disabled", 2), ("enabled", 1)))
...
snmpEnableAuthenTraps = _SnmpEnableAuthenTraps_Object(
    (1, 3, 6, 1, 2, 1, 11, 30), _SnmpEnableAuthenTraps_Type()
)
...
snmpSilentDrops = _SnmpSilentDrops_Object(
    (1, 3, 6, 1, 2, 1, 11, 31), _SnmpSilentDrops_Type()
)
...
snmpProxyDrops = _SnmpProxyDrops_Object(
    (1, 3, 6, 1, 2, 1, 11, 32), _SnmpProxyDrops_Type()
)
...
snmpMIBObjects = _SnmpMIBObjects_ObjectIdentity((1, 3, 6, 1, 6, 3, 1, 1))
_SnmpTrap_ObjectIdentity = ObjectIdentity
snmpTrap = _SnmpTrap_ObjectIdentity((1, 3, 6, 1, 6, 3, 1, 1, 4))
_SnmpTrapOID_Type = ObjectIdentifier
_SnmpTrapOID_Object = MibScalar
snmpTrapOID = _SnmpTrapOID_Object((1, 3, 6, 1, 6, 3, 1, 1, 4, 1), _SnmpTrapOID_Type())
...
snmpTrapEnterprise = _SnmpTrapEnterprise_Object(
    (1, 3, 6, 1, 6, 3, 1, 1, 4, 3), _SnmpTrapEnterprise_Type()
)
...
snmpTraps = _SnmpTraps_ObjectIdentity((1, 3, 6, 1, 6, 3, 1, 1, 5))
_SnmpSet_ObjectIdentity = ObjectIdentity
snmpSet = _SnmpSet_ObjectIdentity((1, 3, 6, 1, 6, 3, 1, 1, 6))
_SnmpSetSerialNo_Type = TestAndIncr
_SnmpSetSerialNo_Object = MibScalar
snmpSetSerialNo = _SnmpSetSerialNo_Object(
    (1, 3, 6, 1, 6, 3, 1, 1, 6, 1), _SnmpSetSerialNo_Type()
)
...
snmpMIBConformance = _SnmpMIBConformance_ObjectIdentity((1, 3, 6, 1, 6, 3, 1, 2))
_SnmpMIBCompliances_ObjectIdentity = ObjectIdentity
snmpMIBCompliances = _SnmpMIBCompliances_ObjectIdentity((1, 3, 6, 1, 6, 3, 1, 2, 1))
_SnmpMIBGroups_ObjectIdentity = ObjectIdentity
snmpMIBGroups = _SnmpMIBGroups_ObjectIdentity((1, 3, 6, 1, 6, 3, 1, 2, 2))

snmpSetGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 5))
snmpSetGroup.setObjects(("SNMPv2-MIB", "snmpSetSerialNo"))
if mibBuilder.loadTexts:
...
systemGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 6))
...
snmpGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 8))
...
snmpCommunityGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 9))
...
snmpObsoleteGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 10))
...
snmpNotificationGroup = ObjectGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 12))
...
snmpBasicNotificationsGroup = NotificationGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 7))
snmpBasicNotificationsGroup.setObjects(
    *(("SNMPv2-MIB", "coldStart"), ("SNMPv2-MIB", "authenticationFailure"))
)
if mibBuilder.loadTexts:
    snmpBasicNotificationsGroup.setStatus("current")
if mibBuilder.loadTexts:
...
snmpWarmStartNotificationGroup = NotificationGroup((1, 3, 6, 1, 6, 3, 1, 2, 2, 11))
snmpWarmStartNotificationGroup.setObjects(("SNMPv2-MIB", "warmStart"))
if mibBuilder.loadTexts:
    snmpWarmStartNotificationGroup.setStatus("current")
if mibBuilder.loadTexts:
...
snmpBasicCompliance = ModuleCompliance((1, 3, 6, 1, 6, 3, 1, 2, 1, 2))
if mibBuilder.loadTexts:
    snmpBasicCompliance.setStatus("deprecated")
if mibBuilder.loadTexts:
...
snmpBasicComplianceRev2 = ModuleCompliance((1, 3, 6, 1, 6, 3, 1, 2, 1, 3))
if mibBuilder.loadTexts:
    snmpBasicComplianceRev2.setStatus("current")
if mibBuilder.loadTexts:
