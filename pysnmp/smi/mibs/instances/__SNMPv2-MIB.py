...
_sysUpTime = MibScalarInstance(sysUpTime.name, (0,), SysUpTime(0))
_sysContact = MibScalarInstance(sysContact.name, (0,), sysContact.syntax.clone(""))
_sysName = MibScalarInstance(sysName.name, (0,), sysName.syntax.clone(""))
_sysLocation = MibScalarInstance(sysLocation.name, (0,), sysLocation.syntax.clone(""))
_sysServices = MibScalarInstance(sysServices.name, (0,), sysServices.syntax.clone(0))
_sysORLastChange = MibScalarInstance(
    sysORLastChange.name, (0,), sysORLastChange.syntax.clone(0)
)
_snmpInPkts = MibScalarInstance(snmpInPkts.name, (0,), snmpInPkts.syntax.clone(0))
_snmpOutPkts = MibScalarInstance(snmpOutPkts.name, (0,), snmpOutPkts.syntax.clone(0))
...
_snmpInTraps = MibScalarInstance(snmpInTraps.name, (0,), snmpInTraps.syntax.clone(0))
...
_snmpOutTraps = MibScalarInstance(snmpOutTraps.name, (0,), snmpOutTraps.syntax.clone(0))
